...
public class MasterDatabase : MonoBehaviour
{
    ...
    {
        ///(SectorID, SectorName)
        tempSectorMasterList.Add(new SectorDataObject(1, "Alcyone", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(2, "Aldebaran", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(3, "Algol", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(4, "Altair", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(5, "Antares", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(6, "Arcturus", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(7, "Atlas", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(8, "Auriga", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(9, "Barnard's Star", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(10, "Bellatrix", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(11, "Betelgeus", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(12, "Caleano", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(13, "Canopus", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(14, "Capella", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(15, "Castor", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(16, "Debenola", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(17, "Deneb", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(18, "Electra", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(19, "Fomalhaut", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(20, "Luyten's Star", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(21, "Maia", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(22, "Merope", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(23, "Pleione", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(24, "Pollux", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(25, "Procyon", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(26, "Proxima Centauri", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(27, "Rasalhague", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(28, "Regulus", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(29, "Rigel", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(30, "Sirius", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(31, "Sol", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(32, "Spica", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(33, "Sterope", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(34, "Taygeta", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(35, "Vega", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(36, "Wolf 359", Vector2.zero));
        tempSectorMasterList.Add(new SectorDataObject(37, "Polaris", Vector2.zero));
